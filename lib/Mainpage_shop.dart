...
class Main_shop extends StatelessWidget {
  @override
  Widget build(BuildContext context) {

    CollectionReference ref_uage = Firestore.instance.collection("Beautyshop");
...
class usage_card extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var data = Record_loca.fromsnapshot(doc);

    return Padding(
        padding: const EdgeInsets.all(4.0),
        child: GestureDetector(
          onTap: () {Navigator.push(context1, MaterialPageRoute(builder: (context) => Locationpage()));},
